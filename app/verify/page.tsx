    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 w-full max-w-sm text-center">
        ...
        <p className="text-gray-400 text-sm mb-6">
          {sent ? 'We sent a 6-digit code to your university email.' : 'Sending code...'}
        </p>
        <input
          type="text"
          maxLength={6}
          ...
          className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3
                     text-white text-center text-2xl tracking-widest mb-4 focus:outline-none
        ...
        <button onClick={sendOTP} className="text-gray-500 text-xs mt-4 hover:text-gray-300">
          Resend code
        </button>
      </div>
    </div>
